...
def show_sitk_img_info(img: sitk.Image):
    ...
    info = {'Pixel Type': pixel_type, 'Dimensions': dimensions, 'Spacing': spacing, 'Origin': origin,
            'Direction': direction}
...
def explore_3D_array_with_mask_contour(arr: np.ndarray, mask: np.ndarray, thickness: int = 1):
    ...
    array. The purpose of this function is to visually inspect the region delimited by the mask.
